...
家庭生日记录与提醒服务。网页通过 `auth.tt829.cn` 的统一 OIDC 身份服务登录，
并要求账号具有 `app-bday` 角色；提醒 CronJob 不依赖浏览器登录态。
...
出生日期支持直接输入或粘贴 `1994-08-29`、`19940829`、`1994/8/29` 或 `1994年8月29日`。点击「日历」可下拉选择年份和月份；选择日期后自动回填并显示双历预览。无效日期会阻止提交，清空日期后可切换为单一历法手动填写月日。
